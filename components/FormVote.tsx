  ...
  return (
    <div>
        ...
        <p className="text-xs text-gray-400 pt-3 text-center">
            Se assolutamente non vuoi averci più a che fare premi "Scarta"
        </p>
        <div className="grid grid-cols-2 pt-4 gap-2 items-center text-center">
            <div>
            ...
            <div>
                <button type='button' onClick={(event) => onClick(event)} className="btn btn-block btn-outline btn-error">
