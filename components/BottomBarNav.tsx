...
const BottomBarNav = () =>{
  ...
  return (
      ...
      <a role="button" href="/dating"className={`${pathname === "/dating" ? activeClass : disableCLass } text-primary `}>
      ...
      <a role="button" href="/" className={`${pathname === "/profile" ? activeClass : disableCLass } text-primary`}>
